...
namespace MolecularWeightCalculatorGUI.Plotting
{
    ...
    /// </summary>
    // From https://github.com/oxyplot/oxyplot/issues/497
    internal class ReusablePlotModel : PlotModel, IPlotModel
    {
        private static readonly MethodInfo BaseAttachMethod = typeof(ReusablePlotModel).BaseType
