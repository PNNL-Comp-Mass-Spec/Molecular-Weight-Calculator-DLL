...
#define Build 1
#define Revision 1
#define FullVersion ParseVersion('..\MolecularWeightCalculatorGUI\bin\Release\MolecularWeightCalculatorGUI.exe', Major, Minor, Build, Revision)
...
#define InstallerFolder "..\Installers\GUI"
#if ReleaseVersion == ""
...
OutputBaseFilename=MolWtCalc_GUI_Installer_v{#ReleaseVersion}
AppCopyright=© PNNL
