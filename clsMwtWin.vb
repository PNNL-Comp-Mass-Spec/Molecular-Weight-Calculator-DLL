...
Public Class MolecularWeightCalculator
	...
	Private Const PROGRAM_DATE As String = "August 6, 2013"
...
#End Region
	...
	Public Function ConvertStickDataToGaussian2DArray(ByVal XYVals As Generic.List(Of Generic.KeyValuePair(Of Double, Double)), ByVal intResolution As Integer, ByVal dblResolutionMass As Double) As Generic.List(Of Generic.KeyValuePair(Of Double, Double))
